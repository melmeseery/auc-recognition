...
public double TruePositive=0; //  TP it is supposed of this class and recognized as is  
	
	public double TrueNegative=0; // TN it is supposed not of this class and recognized as not
	
	public double  FalseNegative=0 ;  // FN it is supposed of this class and recognized as not
	
	public double FalsePositive=0; // FP it is supposed not of this class and recognized as is
	...
	double Accuracy; //  ((TP+TN)/ TotalCount)
	 ...
	 //In information retrieval positive predictive value is called precision, and sensitivity is called recall.
		...
		public void computeStat(){
			...
			Accuracy=(((double)(TrueNegative+TruePositive))/(double)(FalseNegative+TrueNegative+TruePositive+FalsePositive))*100;
