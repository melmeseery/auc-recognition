...
Cairo, Egypt\\
Email: \IEEEauthorrefmark{1}shazeem@aucegypt.edu , \IEEEauthorrefmark{2}melmeseery@aucegypt.edu, \IEEEauthorrefmark{3} hany.aucegypt@gmail.com}
...
\begin{figure}[h]
\centering
 \subfigure['W2']{\label{fig:fig3}\includegraphics[width=0.08\textwidth]{figures/fig3.jpg}}
 \subfigure['W3']{\label{fig:fig4} \includegraphics[width=0.08\textwidth]{figures/fig4.jpg}}
\subfigure['W4'.]{\label{fig:fig5}\includegraphics[width=0.08\textwidth]{figures/fig5.jpg}}
  \subfigure['W5']{\label{fig:fig6}\includegraphics[width=0.08\textwidth]{figures/fig6.jpg}}
 \subfigure['W6]{\label{fig:fig7}\includegraphics[width=0.08\textwidth]{figures/fig7.jpg}}
   \subfigure['W7']{\label{fig:fig9b}\includegraphics[width=0.08\textwidth]{figures/fig9b.jpg}}
...
\subfigure['W10']{\label{fig:fig11b}\includegraphics[width=0.1\textwidth]{figures/fig12b.jpg}}
...
\centering
  ...
  \subfigure[paper]{\label{fig:figpaper}\includegraphics[width=0.17\textwidth]{page.jpg}}
  %\subfigure[Feature 'White\_3'.]{\label{fig:fig8}\includegraphics[width=0.15\textwidth]{figures/fig8.jpg}}

    \subfigure[result]{\label{fig:scriptresult}\includegraphics[width=0.35\textwidth]{res.jpg}}
...
%Future work on the system may include extending the dataset and adding a on-line Arabic character dateset. Also improving the system to accept a string of digits makes the application more applicable in real life applications. % Modifing the system to accept a string of digits may be %Other modefication may be required to change the system to character recognition.
