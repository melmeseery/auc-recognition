...
public class FeatureStat implements Serializable {
	...
	double means[]=new double [App.CATEGORY_SIZE];
	double avg[]=new double [App.CATEGORY_SIZE];
	double std[]=new double [App.CATEGORY_SIZE];
	double max[]=new double [App.CATEGORY_SIZE];
	double min[]=new double [App.CATEGORY_SIZE];
	//double []=new double [App.CATEGORY_SIZE];
	String minFilename[]=new String[App.CATEGORY_SIZE];
	String maxFilename[] =new String[App.CATEGORY_SIZE];  
