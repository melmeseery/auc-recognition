...
public class ImageFrame extends JFrame {
	...
	private String FileName=App.FILE_NAME;  //  @jve:decl-index=0:
	private String DirName=DataBaseConnector.MADbaseBaseDir;  //  @jve:decl-index=0:
	
	private String CurrSelection="";  //  @jve:decl-index=0:
	...
	private JRadioButton jRadioButtonMinist = null;
	 ...
	 ButtonGroup DBgroup =null;  //  @jve:decl-index=0:
	 ButtonGroup DBgroup2 =null;  //  @jve:decl-index=0:
...
//			jContentPane.add(getJRadioTrain(), null);
			jContentPane.add(jPanelRadio2, null);
//			jContentPane.add(getJRadioTest(), null);
			jContentPane.add(getJCheckBoxZero(), null);
//			jContentPane.add(getJRadioTrainAndTest(), null);
	...
	private JRadioButton getJRadioButtonMADBASe() {
		if (jRadioButtonMADBASe == null) {
			...
			jRadioButtonMADBASe.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					  if (getJRadioButtonMADBASe().isSelected())
						  DataBaseChanged(DataBaseConnector.MADBASE);
	...
	private JRadioButton getJRadioButtonADBase() {
		if (jRadioButtonADBase == null) {
			...
			jRadioButtonADBase.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
				//	System.out.println("actionPerformed()"); // TODO Auto-generated Event stub actionPerformed()
					if (getJRadioButtonADBase().isSelected())
						Type=DataBaseConnector.ADBASE;
				}
			});
		}
	...
	private JRadioButton getJRadioButtonMinist() {
		if (jRadioButtonMinist == null) {
			...
			jRadioButtonMinist.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					if (getJRadioButtonMinist().isSelected())
						Type=DataBaseConnector.MNIST;
				}
			});
		}
...
}  //  @jve:decl-index=0:visual-constraint="-13,88"
