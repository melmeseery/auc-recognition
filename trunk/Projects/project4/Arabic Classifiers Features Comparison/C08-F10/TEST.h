...
void TEST()
{
	...
	char pca_matrix_file[]="D:/datasets/arabic_reduced_local_concavity_pca_matrix_for_GC.txt";
	char pca_mu_file[]="D:/datasets/arabic_reduced_local_concavity_pca_mu_for_GC.txt";
