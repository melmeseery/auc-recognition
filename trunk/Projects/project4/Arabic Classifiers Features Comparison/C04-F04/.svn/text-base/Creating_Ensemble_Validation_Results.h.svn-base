...
void Create_Ensemble_Validation_Results()
{
	...
	ofstream fout("C04-F04_ensemble_validation_results.txt");


	char train_file[]="C:/datasets/kirsh4_ourfeatures_latin_training_set_full.txt";
	...
	float g=0.01;//0.0275;//0.04;//gamma
	float C=100;
