...
void Create_Ensemble_Validation_Results()
{
	...
	ofstream fout("C07-F04_ensemble_validation_results.txt");
	...
	char train_file[]="C:/datasets/arabic_pca_kirsh4_ourfeatures_training_set_full.txt";
...
//		real decision_scores[10];// to hold decision scores
//
//		linear_net.forward(unformated_dataset->inputs);//forwarding sample
//
//		for(int i=0; i<10; i++)
//			decision_scores[i] = linear_net.outputs->frames[0][i];
//
