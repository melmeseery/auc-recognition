...
void TEST()
{
	...
	char matrix_file[]="D:/datasets/arabic_kirsh_pca_matrix.txt";
	char mu_file[]="D:/datasets/arabic_kirsh_pca_mu.txt";


	//char test_file[]="D:/datasets/zc_arabic_kirsh4_ourfeatures_testing_set_full.txt";
	//int number_of_features=100;
	//char matrix_file[]="D:/datasets/zc_arabic_kirsh_pca_matrix.txt";
	//char mu_file[]="D:/datasets/zc_arabic_kirsh_pca_mu.txt";
