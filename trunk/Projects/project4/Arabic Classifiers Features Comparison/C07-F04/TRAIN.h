...
void TRAIN()
{
	...
	char train_file[]="D:/datasets/arabic_pca_kirsh4_ourfeatures_training_set_full.txt";
	
//	char train_file[]="C:/datasets/zc_arabic_pca_kirsh4_ourfeatures_training_set_full.txt";
...
//	int number_of_features=N*(N-1)/2+N;;
//
//	char train_file[]="C:/datasets/qpca_kirsh4_ourfeatures_latin_training_set_full.txt";
//	
//
//	// creating the linear machine
//	ConnectedMachine linear_net;
...
//	}
//	DataSet *temp1;
//	temp1=new(allocator) MatDataSet(train_file,number_of_features,1,false,-1,false);
