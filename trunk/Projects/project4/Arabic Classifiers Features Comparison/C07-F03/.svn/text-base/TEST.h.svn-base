...
void TEST()
{
	...
	char matrix_file[]="D:/datasets/arabic_gmask_gradient_pca_matrix.txt";
	char mu_file[]="D:/datasets/arabic_gmask_gradient_pca_mu.txt";


	//char test_file[]="D:/datasets/zc_arabic_gmask_gradproj_ourfeatures_testing_set_full.txt";
	//int number_of_features=201;
	//char matrix_file[]="D:/datasets/zc_arabic_gmask_gradient_pca_matrix.txt";
	//char mu_file[]="D:/datasets/zc_arabic_gmask_gradient_pca_mu.txt";
...
//	Allocator *allocator = new Allocator;
//
//	//char test_file[]="C:/datasets/arabic_pca_gmask_grad_proj_ourfeatures_testing_set_full.txt";
//	char test_file[]="C:/datasets/zc_arabic_pca_gmask_grad_proj_ourfeatures_testing_set_full.txt";
//
//	int N=50;
...
//
//	real accuracy(0);
//	ofstream fout("C07-F03_full_results.txt");
