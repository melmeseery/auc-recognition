...
void TRAIN()
{
	...
	//char train_file[]="C:/datasets/arabic_pca_gmask_grad_proj_ourfeatures_training_set_full.txt";
	char train_file[]="C:/datasets/zc_arabic_pca_gmask_grad_proj_ourfeatures_training_set_full.txt";
