...
void TEST()
{
	...
	int num_of_features= 156;
	char train_file[]="D:/datasets/arabic_low_dim_concat_ourfeatures_training_set_full.txt";
	char test_file[]="D:/datasets/arabic_low_dim_concat_ourfeatures_testing_set_full.txt";

	//int num_of_features= 156+1;
	//char train_file[]="D:/datasets/zc_arabic_low_dim_concat_ourfeatures_training_set_full.txt";
