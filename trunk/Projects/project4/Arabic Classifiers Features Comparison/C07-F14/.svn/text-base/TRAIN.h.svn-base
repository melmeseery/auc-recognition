...
void TRAIN()
{
	...
	//char train_file[]="C:/datasets/arabic_pca_local_chain_ourfeatures_training_set_full.txt";
	char train_file[]="C:/datasets/zc_arabic_pca_local_chain_ourfeatures_training_set_full.txt";
