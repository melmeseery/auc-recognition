...
void TEST()
{
	...
	char matrix_file[]="D:/datasets/arabic_local_chain_pca_matrix.txt";
	char mu_file[]="D:/datasets/arabic_local_chain_pca_mu.txt";


	//char test_file[]="D:/datasets/zc_arabic_local_chain_ourfeatures_testing_set_full.txt";
	//int number_of_features=200;
	//char matrix_file[]="D:/datasets/zc_arabic_local_chain_pca_matrix.txt";
	//char mu_file[]="D:/datasets/zc_arabic_local_chain_pca_mu.txt";
