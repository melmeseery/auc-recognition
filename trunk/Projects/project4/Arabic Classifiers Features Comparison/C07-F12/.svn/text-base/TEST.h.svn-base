...
void TEST()
{
	...
	char test_file[]="D:/datasets/arabic_low_dim_concat_ourfeatures_testing_set_full.txt";
	int number_of_features=156;
	char matrix_file[]="D:/datasets/arabic_low_dim_concat_pca_matrix.txt";
	char mu_file[]="D:/datasets/arabic_low_dim_concat_pca_mu.txt";


	//char test_file[]="D:/datasets/zc_arabic_low_dim_concat_ourfeatures_testing_set_full.txt";
	//int number_of_features=156;
	//char matrix_file[]="D:/datasets/zc_arabic_low_dim_concat_pca_matrix.txt";
	//char mu_file[]="D:/datasets/zc_arabic_low_dim_concat_pca_mu.txt";
