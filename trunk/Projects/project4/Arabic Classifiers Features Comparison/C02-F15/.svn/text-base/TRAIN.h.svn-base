...
void TRAIN()
{
	...
	const int mnist_digits_counts[]={5923, 6742, 5958, 6131, 5842, 5421, 5918, 6265, 5851, 5949};
	...
	for(int i=0;i<=8;i++)
	{
		for(int j=i+1;j<=9;j++)
		{
			...
			int num_of_training_samples= mnist_digits_counts[i]+mnist_digits_counts[j];
			...
			//current_train_set->n_examples= 12000;
