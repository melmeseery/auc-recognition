...
load zc_arabic_PCA_kirsh4_training_set PCA_training_set

N=50;

fid_train= fopen('zc_arabic_pca_kirsh4_ourfeatures_latin_training_set_full.txt','wt');
...
load zc_arabic_PCA_kirsh4_testing_set PCA_testing_set

fid_test= fopen('zc_arabic_pca_kirsh4_ourfeatures_latin_testing_set_full.txt','wt');
