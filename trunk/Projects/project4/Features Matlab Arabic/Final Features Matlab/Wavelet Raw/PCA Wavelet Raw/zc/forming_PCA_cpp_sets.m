...
load zc_arabic_PCA_wavelet_raw_training_set PCA_training_set

N=50;

fid_train= fopen('zc_arabic_pca_wavelet_raw_ourfeatures_latin_training_set_full.txt','wt');
...
load zc_arabic_PCA_wavelet_raw_testing_set PCA_testing_set

fid_test= fopen('zc_arabic_pca_wavelet_raw_ourfeatures_latin_testing_set_full.txt','wt');
