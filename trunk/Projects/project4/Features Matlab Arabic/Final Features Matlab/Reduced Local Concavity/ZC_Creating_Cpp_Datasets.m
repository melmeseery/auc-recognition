...
fid= fopen('zc_arabic_reduced_local_concavity_ourfeatures_training_set_full.txt','wt');
fprintf(fid,'%d %d \n',60e3,225+1+1);

load('C:\Documents and Settings\XPPRESP3\Desktop\training_set_labels');

format=[repmat('%d ',1,225+1+1) '\n'];
...
fid= fopen('zc_arabic_reduced_local_concavity_ourfeatures_testing_set_full.txt','wt');
fprintf(fid,'%d %d \n',10e3, 225+1+1);
