...
load zc_arabic_PCA_gmask_grad_proj_training_set PCA_training_set

N=50;

fid_train= fopen('zc_arabic_pca_gmask_grad_proj_ourfeatures_latin_training_set_full.txt','wt');
...
load zc_arabic_PCA_gmask_grad_proj_testing_set PCA_testing_set

fid_test= fopen('zc_arabic_pca_gmask_grad_proj_ourfeatures_latin_testing_set_full.txt','wt');
