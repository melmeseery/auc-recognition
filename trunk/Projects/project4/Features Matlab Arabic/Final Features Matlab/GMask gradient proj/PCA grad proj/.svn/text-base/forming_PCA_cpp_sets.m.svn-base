...
load arabic_PCA_gmask_grad_proj_training_set PCA_training_set

N=50;

fid_train= fopen('arabic_pca_gmask_grad_proj_ourfeatures_training_set_full.txt','wt');
...
load arabic_PCA_gmask_grad_proj_testing_set PCA_testing_set

fid_test= fopen('arabic_pca_gmask_grad_proj_ourfeatures_testing_set_full.txt','wt');
