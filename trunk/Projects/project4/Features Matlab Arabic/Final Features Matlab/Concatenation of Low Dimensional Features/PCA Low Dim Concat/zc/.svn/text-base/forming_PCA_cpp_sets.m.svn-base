...
load zc_arabic_PCA_low_dim_concat_training_set PCA_training_set

N=50;

fid_train= fopen('zc_arabic_pca_low_dim_concat_ourfeatures_training_set_full.txt','wt');
...
load zc_arabic_PCA_low_dim_concat_testing_set PCA_testing_set

fid_test= fopen('zc_arabic_pca_low_dim_concat_ourfeatures_testing_set_full.txt','wt');
