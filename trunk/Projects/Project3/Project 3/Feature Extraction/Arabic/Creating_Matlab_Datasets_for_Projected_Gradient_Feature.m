...
%     imshow(I)
%     input('zeo:')
    training_set(n,:)= Local_Gradient_proj(I);



end

save arabic_grad_proj_training_set training_set
...
for n=1:10e3
    ...
    testing_set(n,:)= Local_Gradient_proj(I);



end

save arabic_grad_proj_testing_set testing_set
