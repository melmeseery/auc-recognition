...
//				real decision = svms[i][j]->outputs->frames[0][0];
//
//				scores[t-50000]=decision;
//			}
//
//			float max_scores_value; long max_index;
//			getMax(scores, 10000, max_scores_value, max_index);
//			float min_scores_value; long min_index;
//			getMin(scores, 10000, min_scores_value, min_index);
//			
//			float delta=(max_scores_value-min_scores_value)/N;
//			
//			fout<<max_scores_value<<endl<<min_scores_value;
//			
//			for(int t=0; t<10000; t++)
//			{
//				for(int c=0; c<N; c++)
//					if(scores[t]>=min_scores_value+c*delta && scores[t]<=min_scores_value+(c+1)*delta)
//						hist[c]++;
//			}
//
//			for(int c=0; c<N; c++)
