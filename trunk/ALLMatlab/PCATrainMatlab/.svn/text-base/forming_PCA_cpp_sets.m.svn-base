...
% 
% load arabic_PCA_reduced_local_concavity_training_set PCA_training_set
% 
% N=50;
% 
% fid_train= fopen('arabic_pca_reduced_local_concavity_ourfeatures_latin_training_set_full.txt','wt');
...
fid_test= fopen('arabic_pca_reduced_local_concavity_ourfeatures_latin_testing_set_full.txt','wt');
