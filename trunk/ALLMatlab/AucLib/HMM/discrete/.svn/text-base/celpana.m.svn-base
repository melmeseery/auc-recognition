function [kappa,k,theta0,P,b,ebuf,Zf,Zw] = celpana(x,L,M,c,cb,Pidx,bbuf,...
                                                                   ebuf,Zf,Zw)
%  celpana --> CELP analyzer (coder).
%
%  <Synopsis>
%    [kappa,k,theta0,P,b,ebuf,Zf,Zw] = celpana(x,L,M,c,cb,Pidx,bbuf,...
%                                                              ebuf,Zf,Zw)
%
%  <Description>
...
%      Processing of Speech Signals", IEEE Press, p. 480, (2000).
%
%  <Revision>
