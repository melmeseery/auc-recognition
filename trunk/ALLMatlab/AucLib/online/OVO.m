function [Features]=OVO(Image)%digit=0;digit=3;digit=3;digit=3;
...
% imshow(m28);
 % Alltime(k)=toc(feat);    
%--------------------------------------------------------------------------
%Features=[w2r,wu,w4,wrb,wd,wre,wce,wcb];
%Features=[w2r,wu,w4lft,w4];%ovo2
Features= [w2r,w4lft,w4,wrb,wd,wre,lxrb,wce,sr,cbe,wcbe,HW];%ovo1 Best result ever... 
% [w2r,w4lft,w4,wrb,wre,lxrb,wce,sr,cbe,wcbe,HW];98.34
% [w2r,w4lft,w4,wrb,wre,lxrb,wce,sr,cbe,wcbe,HW] 98.6
% [w2r,w4lft,w4,wrb,wd,wre,lxrb,wce,sr,cbe,wcbe,HW] 98.6
% [w2r,wu,w4lft,w4,wrb,wd,wre,lxrb,wre,wce,sr] 98,43
% [w2r,wu,w4lft,w4,wrb,wd,wre,lxrb,wce,sr,HW] 98.47
% [w2r,wu,w4lft,w4,wrb,wd,wre,wce,wcb,lxrb,wre,wce,sr]
