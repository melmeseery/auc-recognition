function [featureSet,Alltime]=OVO(A,Base,Ssize,digit)%digit=0;digit=3;
% c1=0;c2=0;
% th=20;
% kb=digit*Base;
% %--------------------------------------------
...
% end
% %--------------------------------------------------------------------------
% wu=0;w2r=0;w4lft=0;wd=0;w4=0;W4=0.25*W;
...
% mce69=mean(lce(1:W2));
% %--------------------------------------------------------------------------
% Features=[HW,vol2,Vol(1),Vol(2),w2r,wu,w4lft,w4,wrb,mxb,wd,u1,smallwd,sre,mce69,sr];
...
%--------------------------------------------------------------------------
 Features=[HW,vol2,Vol(1),Vol(2),w2r,wu,w4lft,w4,wrb,mxb,wd,u1,smallwd,sre,mce69,sr,im,wce];
%Features=[HW,vol2,Vol(1),Vol(2),w2r,wu,w4lft,w4,wrb,mxb,wd,u1,smallwd,sre,mce69,sr];
featureSet(k,:)=Features;
