function [featureSet]=a89(A,Base,digit)
%digit=8;
c1=0;c2=0;
th=20;
%--------------------------------------------
...
%k=583&586 w4>wd
%--------------------------------------------------------------------------
Features=[wd,w4,mxb,lxb,wratio,wdlce,wcbe];
%Features=[wd<3,w4>wd,w4>=3&wd>10*w4,mxb>=0.25&lxb<0.5,mxb>=0.25&wratio<0.5,wd>55,mxb>=0.25&lxb<=0.9&wdlce<=2.6&wcbe>=1]
