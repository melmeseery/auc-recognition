...
%---------------------------------------------
      temp=[Concavity(double(I))'; Down_Sample(double(I))'; Projections(double(I))'; Num_of_Crossings(double(I))';] ;
        f=[Centroid16FE(double(I));  temp; FixedSizeProfile_2(double(I),10,10);];
 % f= RawImage_Wavelet_FE(double(I));
  Alltime(k)=toc(feat);       
%--------------------------------------------------------------------------
