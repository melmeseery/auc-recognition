function [featureSet]=a29(A,Base,digit)
...
% %--------------------------------------------------------------------------
% fl2=0;fl9=0;
% wd=0;im=0;hb=H-H2+1;fl8=0;w2r=0;jm=0;w2l=0;jm=W;w4=0;
% for i=1:H
%     for j=W:-1:1
%         if (~m(i,j))
%             if(j>lrb(i)&j<lre(i)&i>lcb(j)&i<lce(j))w4=w4+1;   
...
% 
% %if(~fl2&~fl9)
% %   if(w2r>20)I,disp=[w4,w2r,wrb,k],keyboard,end 
% %end    
% 
% 
% %if (fl2)c1=c1+1;else c2=c2+1;end
% %--------------------------------------------------------------------------
% Features=[w2r,jm/W2,wrb];
c1=0;c2=0;
th=20;
%--------------------------------------------
kdgt=digit*Base*28;
