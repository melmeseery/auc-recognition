function [featureSet]=a23(A,Base,digit)
%digit=3;
c1=0;c2=0;
th=20;
%--------------------------------------------
...
elseif(u1>1)fl3=1;elseif(u1==1&wu>8)fl3=1;
...
%10 mistakes in 3
%--------------------------------------------------------------------------
Features=[wu,w2r,xlcb,mxlrb,mxlre,lxre,lxrb,swc,u1,slcb,sh1,wlrb,mlcb,lcb(1)];
