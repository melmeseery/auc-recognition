%
function [featureSet]=a24(A,Base,digit)
%digit=2;
c1=0;c2=0;
th=20;
%--------------------------------------------
...
%     c2=c2+1;
%     if(snve>=2)
%         I,disp=[spve,snve,mxce,lxce,bbot,btop,w2r,snv,bcol,wcol,mxb,w4lft,sle,k],
%         disp2=[lre3],keyboard,
%     end
% end    
...
%Features=[w2r,w4lft,sle,mxb,snv,lne,bcol,wcol,bbot,btop,mxce,lxce];
Features=[w2r,w4lft,sle,mxb,snv,lne,bcol,wcol,bbot,btop,mxce,lxce];
