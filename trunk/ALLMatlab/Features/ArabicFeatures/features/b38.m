function [featureSet]=b38(A,Base,digit)
%digit=8;
c1=0;c2=0;
th=20;
%--------------------------------------------
...
%--------------------------------------------------------------------------
wd=0;fl3=0;im=0;hb=H-H2+1;fl8=0;w2r=0;w4=0;wcbe=0;wu=0;
for i=1:H
    for j=W:-1:1
        if (~m(i,j))
...
if (wd<3)fl3=1;
elseif (wd<15&im<H2)fl3=1;
elseif (wu>=wd)fl3=1;
elseif(wu&wd&wu-wd>=-3)fl3=1;
end    
