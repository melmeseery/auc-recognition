...
function [featureSet]=a37(A,Base,digit)
%digit=3;
c1=0;c2=0;
th=20;
%--------------------------------------------
...
%--------------------------------------------------------------------------
%Features=[wu,im,sre,mnte,(im-lmn),sre2&lmn<=H3,wr,sba/sbb,sce,wb37,wlre,ss
%3,vb121,vb120,ssvb,ffvb];
Features=[wu,im,sre,mnte,(im-lmn)];
