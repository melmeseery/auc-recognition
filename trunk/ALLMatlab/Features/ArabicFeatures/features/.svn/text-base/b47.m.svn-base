function [featureSet]=b47(A,Base,digit)
%digit=4;
c1=0;c2=0;
th=20;
%--------------------------------------------
...
%--------------------------------------------------------------------------
wu=0;wb=0;wul=zeros(1,H);wulf=0;fl4=0;hb=H-H2+1;pt=0;st34=0;sb4=10;mxfe4=0;spt=10;mxt34=0;w4lft=0;
for i=1:H
    for j=1:W
        if (~m(i,j))
           if(i<lcb(j)&j>lrb(i)&j<lre(i))wu=wu+1;
