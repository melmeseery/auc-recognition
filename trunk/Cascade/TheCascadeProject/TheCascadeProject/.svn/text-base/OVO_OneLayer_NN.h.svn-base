...
#ifndef OVO_ONELAYER_NN_CLASS
#define OVO_ONELAYER_NN_CLASS

//#include "Common_Definitions.h"
#include "GeneralMachine.h"

class OVO_OneLayer_NN: public  GeneralMachine
{
...
private:
	...
	int n_inputs;
	int n_outputs;
	MemoryDataSet *current_train_set;

public:
	//OVO_OneLayer_NN();
	OVO_OneLayer_NN(int number_of_inputs, int number_of_outputs);
	~OVO_OneLayer_NN();
	void train(DataSet* train_set);
	void forward(Sequence* seq);
	void load(char* file_name);//not-functioning
	void save(char* file_name);//not-functioning
