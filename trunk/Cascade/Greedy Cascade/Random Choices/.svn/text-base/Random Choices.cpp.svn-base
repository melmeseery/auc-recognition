// Random Choices.cpp : Defines the entry point for the console application.
//
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	ofstream fout("Greedy_Random_Choices_Results.txt");
...
//#include "MNIST_Generate_Test_Performance_Lists_Vector.h"
//#include "Select_Subpools_From_Pool.h"
//#include "Build_Exhaustive_Cascade.h"
//
//
//
//int _tmain(int argc, _TCHAR* argv[])
...
//
//
//	ofstream fout("complexities.txt");
