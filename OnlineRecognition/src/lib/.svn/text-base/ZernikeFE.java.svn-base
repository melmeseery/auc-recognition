...
public class ZernikeFE  {
     ...
     */
    public static int DEFAULT_ORDER = SystemSettings.DEFAULT_ZERNIKE_ORDER; //8;
     ...
     */
    public double[] apply(SimpleInkObject [] s) {
     ...
     * specified order.
     */
    public double[] apply(SimpleInkObject [] s, int order) {
     ...
     */
    public static double[] zernikeMoments(SimpleInkObject [] s){
    ...
    public static double[] zernikeMoments(SimpleInkObject [] s, int order) {
