...
public class GeometryUtil {
     ...
     */
    public static void strokesToArrays(SimpleInkObject[] strokes, double[][] xvals,double[][] yvals, int[] npoints){
        for(int i=0; i<strokes.length; i++){
          SimpleInkObject s=strokes[i];
     ...
     */
    public static Rectangle2D getBounds(SimpleInkObject[] s) {
        Rectangle2D bbox = s[0].getBox();
     ...
     */
    public static AffineTransform normScaling(SimpleInkObject[] strokes,double height, double width){
        double xmin = Double.MAX_VALUE;
        double ymin = Double.MAX_VALUE;
        double xmax = Double.MIN_VALUE;
        double ymax = Double.MIN_VALUE;
        for(int i=0; i<strokes.length; i++){
            Rectangle2D bounds = strokes[i].getBox();
     ...
     */
    public static double pathLength(SimpleInkObject s) {
        double len = 0;
