...
//				DebugFrame.setFont(font);
    ...
    public static void drawLine(Graphics2D g, Color c, Line2D l) {
    	Color temp=g.getColor();
    	g.setColor(c);
...
//	}
	...
	public static void drawRectangle(Graphics2D g, Rectangle2D box) {
	...
	public static void drawRectangle(Graphics2D g, Rectangle2D box, Color ci) {
	...
	public static void drawRectangle(Graphics2D g, Rectangle2D box, double sx,double sy, double hi) {
...
//		AffineTransform t=new AffineTransform();
	...
	//	g.setColor(ci);
		//g.setStroke()
		//g.draw(box);
		int x= (int)(box.getX()/sx);
		double dy= (box.getY()/sy);
		int y=(int) (box.getY()/sy);
	    int w= (int)(box.getWidth()/sx);
		int h=(int) (box.getHeight()/sy);



		g.drawRect(x,(int)(hi-h-dy),w,h );
